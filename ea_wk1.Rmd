...
# Synopsis
This analysis of NOAA Storm Databse information seeks to determine the types of 
weather events which cause the most damage to citizens' health and the economy 
in the US. Based on the findings proposals were made for how to effectively 
direct mitigation strategies, and further research was suggested in order to aid
